...
def reconcile_vouchers(bank_transaction_name, vouchers):
	...
	for voucher in vouchers:
		...
		if reconcilied_amount < transaction.unallocated_amount:
			frappe.throw(f'El monto no asignado de la transacción {transaction.unallocated_amount} es mayor al monto no conciliado del documento {reconcilied_amount}.')
