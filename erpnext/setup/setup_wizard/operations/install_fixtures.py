...
def install(country=None):
	records = [
		...
		{'doctype': 'Domain', 'domain': 'ERPNext Integrations'},
		{'doctype': 'Domain', 'domain': 'Quality Management'},
		{'doctype': 'Domain', 'domain': 'Loan Management'},
		{'doctype': 'Domain', 'domain': 'Payroll'},
		{'doctype': 'Domain', 'domain': 'Website'},
		{'doctype': 'Domain', 'domain': 'Shopping Cart'},
		{'doctype': 'Domain', 'domain': 'Tools'},
		{'doctype': 'Domain', 'domain': 'Workflow'},
		{'doctype': 'Domain', 'domain': 'Custom'},
		{'doctype': 'Domain', 'domain': 'Automation'},
		{'doctype': 'Domain', 'domain': 'Event Streaming'},
		{'doctype': 'Domain', 'domain': 'Utilities'},
		...
		{'doctype': 'Domain', 'domain': 'HR Asistencia, Vacaciones y Rendimiento de Gastos'},
		...
		{'doctype': 'Domain', 'domain': 'Compreahora'},
		{'doctype': 'Domain', 'domain': 'Usuario de Ventas Reducido'},
		{'doctype': 'Domain', 'domain': 'Usuario de Soporte Reducido'},
		{'doctype': 'Domain', 'domain': 'Usuario de Proyecto Reducido'},
