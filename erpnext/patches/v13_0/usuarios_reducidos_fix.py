...
def execute():
	...
	d.name = 'Usuario de Ventas Reducido'
	d.domain = 'Usuario de Ventas Reducido'
	d.save()

	d = frappe.new_doc('Domain')
	d.name = 'Usuario de Proyecto Reducido'
	d.domain = 'Usuario de Proyecto Reducido'
	d.save()

	d = frappe.new_doc('Domain')
	d.name = 'Usuario de Soporte Reducido'
	d.domain = 'Usuario de Soporte Reducido'
	d.save()
	frappe.db.commit()
