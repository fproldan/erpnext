	...
	for d in entries:
		if d.stock_qty > 0 or filters.get('show_return_entries', 0):
			data.append([
				...
				d.stock_qty, d.net_amount, d.sales_person, d.porcentaje_comision, d.importe_comision, company_currency
			])
...
def get_entries(filters):
	...
	entries = frappe.db.sql("""
		SELECT
			dt.name, dt.customer, dt.territory, dt.%s as posting_date, dt_item.item_code, dt_item.porcentaje_comision, dt_item.importe_comision, dt_item.net_amount,
